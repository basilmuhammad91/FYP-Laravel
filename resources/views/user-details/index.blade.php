...
<div class="content">
  ...
  </noscript><table class="table table-hover">
                    <tbody>
                    	<tr>
	                        <th>Name</th>
	                        <th>Father Name</th>
	                    ...
	                    <tr>
	                        ...
	                        <td>{{ $obj->cnic_no }}</td>
	                        <td>{{ $obj->phone_no_personal }}</td>
	                        <td>{{ $obj->phone_no_residence }}</td>
	                        <td>{{ $obj->status }}</td>
	                        <td>
	                        	<a href="{{action('UserDetailController@edit')}}?id={{$obj->user_detail_id}}">Edit</a>
	                        	<a href="{{action('UserDetailController@delete')}}?id={{$obj->user_detail_id}}">Delete</a>
	                        </td>
	                    </tr>
