          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h2 class="card-title"><b>01</b>
                    <small></small>
                  </h2>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <a href="" class="card-category" style="color: #FB8F04; font-size: 20px"><b>Registered Customers</b></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h2 class="card-title"><b>10</b></h2>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <a href="" class="card-category" style="color: #48A44C; font-size: 20px"><b>Registered Ambulance Drivers</b></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    <a href="" class="card-category" style="color: #08B2C6; font-size: 20px"><b>Registered Vendors</b></a>
                  </div>
                </div>
              </div>
            </div>
